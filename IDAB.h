...
public:
	...
	int IDAB_F3(const MyBoard &board, const int alpha, const int beta, const int evil_count, const double max_sec);
	int IDAB_G3(const MyBoard &board, const int alpha, const int beta, const int evil_count, const double max_sec);
	int limit;
	TD td;
};
